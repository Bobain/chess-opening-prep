...
For each game, we define which moves are brilliant or great. All other
moves are implicitly 'other'. Tests classify every move and compute
...
GAMES: list[dict] = [
    ...
    },
    {
        ...
        "great_indices": [],
        "notes": {
            52: "Rxe6 — trapped rook, 'sacrifice' only minimizes losses",
        },
    },
    {
